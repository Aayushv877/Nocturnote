  ...
  <div transition:fade={{ duration: 150 }} class="absolute inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm no-drag" onclick={() => showAbout = false}>
    <div transition:scale={{ duration: 200, start: 0.95 }} class="w-[400px] bg-[#18181b] border border-[#2e3245] rounded-xl shadow-2xl overflow-hidden" onclick={(e) => e.stopPropagation()}>
      ...
      <div class="px-6 py-4 border-b border-[#2e3245] flex justify-between items-center bg-[#0e1019]">
        ...
        <button onclick={() => showAbout = false} class="text-[#71717a] hover:text-[#f4f4f5] transition-colors text-xs uppercase tracking-wider font-bold">Close</button>
      </div>
      ...
      <div class="p-8 flex flex-col items-center text-center space-y-6">
        ...
        <div class="flex items-center justify-center gap-3 text-xs font-mono text-[#71717a] bg-[#2e3245]/30 px-3 py-1.5 rounded-full border border-[#2e3245]">
        ...
        <div class="grid grid-cols-2 gap-3 w-full pt-4">
            <a href="https://github.com/fezcode/nocturnote" target="_blank" class="flex items-center justify-center gap-2 h-10 rounded-lg bg-[#27272a] hover:bg-[#3f3f46] text-[#e4e4e7] transition-colors text-sm font-medium">
                <Github size="16" />
                <span>GitHub</span>
            </a>
            <a href="https://fezcode.com" target="_blank" class="flex items-center justify-center gap-2 h-10 rounded-lg bg-[#27272a] hover:bg-[#3f3f46] text-[#e4e4e7] transition-colors text-sm font-medium">
                <Globe size="16" />
